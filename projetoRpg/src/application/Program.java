...
public class Program {
	...
	public static void main(String[] args) {
		...
		Market freya= new Market("freya", "Dirty Helment", "1.helment, 2. potion, 3. magic", "market of Dirty Helment", 30,15,80,120);
		...
		if(!game) continue;
		int bounty = random.nextInt(10)+1+random.nextInt(10)+1+random.nextInt(10)+1+random.nextInt(10)+1;
