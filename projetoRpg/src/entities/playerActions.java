...
public class playerActions {
	public static Player characterCreation(Scanner input, Random random) {
		...
		Player player = new Player(name, pv, strength, constitution, agility, dexterity, potion, 0);
		return player;
	...
	public static Weapon weaponSelector(Scanner input, Weapon weapon1, Weapon weapon2) {
		...
		while (1 != 0) {
			System.out.println(
					"which weapon do you want? " + weapon1.getWeaponName() + "[1], " + weapon2.getWeaponName() + "[2]");
	...
	public static Magic magicSelector(Scanner input, Magic magic1, Magic magic2, Magic magic3) {
		...
		while (1 != 0) {
			System.out.println("which magic spell do you want? " + magic1.getMagicName() + "[1], "
					+ magic2.getMagicName() + "[2], " + magic3.getMagicName() + "[3]");
			int choice = input.nextInt();
			int x;
			switch (choice) {
			case 1:
	...
	public static Market marketsOnGame(Scanner input, Player player, Market market, Magic magic1, Potion potion1,
			Weapon weapon, Armor armor) {

		while (1 != 0) {
			System.out.println("\nwhat do you want to buy? \n1. " + magic1.getMagicName() + " = "
					+ market.getMagicCost() + "\n2. potion = " + market.getPotionCost() + "\n3. "
					+ weapon.getWeaponName() + " = " + market.getWeaponCost() + "\n4. " + armor.getArmorName() + " = "
					+ market.getArmorCost() + "\n5.sair ");
	...
	public static Armor armorSelector(Scanner input, Armor armor1, Armor armor2) {
		...
		while (1 != 0) {
			System.out.println(
					"which armour do you want? " + armor1.getArmorName() + "[1], " + armor2.getArmorName() + "[2]");
			int choice = input.nextInt();
			int x;
			switch (choice) {
			case 1:
	...
	public static void levelUp(Scanner input, int level, Player player) {
		...
		System.out.println("Congratulations you leveled up!!!!! \nYou have gained " + level
				+ " attribute points, allocate them correctly:\n\n");
